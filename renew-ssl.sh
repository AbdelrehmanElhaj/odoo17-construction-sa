...
sudo cp "$ROOT/config/certbot/certs/live/csm.hdrelhaj.com/fullchain.pem" "$ROOT/config/certs/nginx.crt"
sudo cp "$ROOT/config/certbot/certs/live/csm.hdrelhaj.com/privkey.pem"   "$ROOT/config/certs/nginx.key"
